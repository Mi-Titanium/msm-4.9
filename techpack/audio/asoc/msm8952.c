...
#undef S
	 ...
	 * 360-680 == Button 3
	 */
#if defined(CONFIG_MACH_XIAOMI_SAKURA) || defined(CONFIG_MACH_XIAOMI_TIFFANY) || defined(CONFIG_MACH_XIAOMI_VINCE) || defined(CONFIG_MACH_XIAOMI_YSL)
	btn_low[0] = 91;
	btn_high[0] = 91;
	btn_low[1] = 259;
	btn_high[1] = 259;
...
static struct snd_soc_dai_link msm8952_dai[] = {
...

	{
		...
		.platform_name = "msm-pcm-routing",
/* this change breaks the ysl audio, it needs adaptation to make the ysl audio work */
#ifdef CONFIG_SND_SOC_TAS2557
